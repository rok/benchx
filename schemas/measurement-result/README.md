...
| [`../../tools/measurement_arrow_schema.py`](../../tools/measurement_arrow_schema.py) | Static PyArrow schema and derived construction schema. |
| [`../../tools/measurement_arrow.py`](../../tools/measurement_arrow.py) | Reference JSON-to-Arrow and Parquet implementation. |
...
from measurement_arrow import (
    message_to_arrow_table,
    messages_to_arrow_table,
)
```

Callers using these functions directly are responsible for strict parsing and
message validation.
